                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <form @submit.prevent="saveOwner" class="p-6 flex flex-col justify-center">
                            ...
                            <div class="flex flex-col mt-2">
                                <label for="tel" class="hidden">Número telefónico secundario (Opcional)</label>
                                <input type="tel" minlength="10" maxlength="10" v-model="formOwner.secondary_phonenumber" placeholder="Ingresa un número telefónico de 10 dígitos secundario" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none"/>
                            </div>
                            <button type="submit"
