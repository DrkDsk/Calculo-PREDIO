            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
                <div
                    ...
                    <div class="text-right">
                        <p class="text-2xl">{{ownersCount}}</p>
                        <p>Propietarios</p>
                    </div>
                </div>
                <div
                    ...
                    <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <form @submit.prevent="saveOwner" class="p-6 flex flex-col justify-center">
                            ...
                            <div class="flex flex-col mt-2">
                                ...
                                <input v-model="formOwner.RFC" placeholder="Ingresa el RFC" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none"/>
                            </div>

                            <div class="flex flex-col mt-2">
                                <label for="tel" class="hidden">Número telefónico</label>
                                <input v-model="formOwner.telephone" placeholder="Ingresa un número telefónico de 10 dígitos" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none"/>
                            </div>
                            <button type="submit"
