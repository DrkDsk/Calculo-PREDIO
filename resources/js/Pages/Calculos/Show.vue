                            ...
                            <div class="relative">
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="my-4">
                                        ...
                                        <input disabled v-model="balance.year_at_operation_date" type="text"
                                    ...
                                    <div class="my-4">
                                        ...
                                        <input disabled v-model="balance.due_payment_year" type="text"
                                               class="bg-gray-100 block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 border border-gray-300 rounded-md focus:outline-none focus:border-black">
                                    </div>
                                    ...
                                    <div class="my-4">
                                        ...
                                        <input disabled v-model="balance.month_at_operation_date" type="text"
                                               class="bg-gray-100 block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 border border-gray-300 rounded-md focus:outline-none focus:border-black">
                                    </div>
                                    ...
                                    <div class="my-4">
                                        ...
                                        <input v-model="balance.INCP_at_operation_date" type="text"
                                    ...
                                    <div class="my-4">
                                        ...
                                        <input v-model="balance.INCP_applied" type="text"
                                               class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 border border-gray-300 rounded-md focus:outline-none focus:border-black"
                                    ...
                                    <div class="relative">
                                        ...
                                        <input v-model="balance.amount" type="text"
                                               class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 border border-gray-300 rounded-md focus:outline-none focus:border-black"
                                    ...
                                    <div class="relative">
                                        <label class="rounded-md absolute px-2 ml-2 -mt-3 font-medium text-gray-600">Tasa de
                                            Recargo</label>
                                        <input v-model="balance.surcharge_rate" type="text"
                                               class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 border border-gray-300 rounded-md focus:outline-none focus:border-black"
